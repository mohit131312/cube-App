...
import 'package:cube_app/lab_operator/enter_test_result/enter_test_result_screen.dart';

import 'package:cube_app/lab_operator/lab_operator_controller.dart';
...
class LabOperatorScreen extends StatelessWidget {
  LabOperatorScreen({super.key});
  final LabOperatorController labOperatorController =
      Get.put(LabOperatorController());
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              GridView.builder(
                ...
                itemCount: labOperatorController.selectGridData.length,
                ...
                itemBuilder: (context, index) {
                  final item = labOperatorController.selectGridData[index];
