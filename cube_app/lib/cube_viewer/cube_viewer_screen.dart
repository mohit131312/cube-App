...
import 'package:cube_app/cube_viewer/cube_viewer_controller.dart';
import 'package:cube_app/cube_viewer/schedule_act_report/schedule_act_report_screen.dart';
...
class CubeViewerScreen extends StatelessWidget {
  CubeViewerScreen({super.key});
  final CubeViewerController cubeViewerController =
      Get.put(CubeViewerController());
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              GridView.builder(
                ...
                itemCount: cubeViewerController.selectGridData.length,
                ...
                itemBuilder: (context, index) {
                  final item = cubeViewerController.selectGridData[index];
